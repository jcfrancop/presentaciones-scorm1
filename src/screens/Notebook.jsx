  ...
  return (
    <>
      <section>
        ...
        <p>
          Tienes más información de la que puedes procesar manualmente. Gemini
          Notebook te permite{" "}
          <b>subir tus fuentes y pedirle que identifique los hallazgos</b> más
          relevantes para tu tema.{" "}
        </p>

        <p>
          <b>Lo que hace Gemini Notebook:</b> lee y conecta múltiples
          documentos, genera resúmenes, responde preguntas sobre el contenido.
        </p>
        <p>
      ...
      {sourcesProcessed && (
        <button onClick={() => setCurrentScreen("question2")}>Siguiente</button>
      )}
    </>
  );
}
